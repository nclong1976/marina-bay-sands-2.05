...
// 9 thẻ trang chủ — dùng ĐÚNG 9 mã gameId đã thiết kế sẵn trong
// src/components/awards/gamesData.js (mục Giải Thưởng/Kết quả xổ trực tiếp), để trang
// chủ và trang Giải Thưởng luôn khớp nhau: chơi "New Zealand May Mắn 28" ở trang chủ thì
// xem kết quả/biểu đồ "New Zealand May Mắn 28" ở Giải Thưởng cũng ra đúng ván đó. Mỗi mã
// là 1 bàn/ván chơi trực tiếp hoàn toàn độc lập (giờ quay, kết quả xổ, tỷ lệ thưởng riêng
// — xem getGameConfig trong gameConfig.js để biết cách các mã cùng thể loại vẫn dùng
// chung giao diện cược với bàn gốc).
// title để trống ("") có chủ đích — mỗi ảnh nền (bg) đã có sẵn tên trò chơi vẽ ngay trong
// ảnh (banner tím ở đáy ảnh), nên KHÔNG set title ở đây để tránh chữ bị chồng lặp 2 lần
// (chữ trong ảnh + chữ do GameCard.jsx render đè lên) — xem GameCard.jsx dòng render title.
export const GAMES = [
  { id: "g1", gameId: "lucky28-kr", title: "", category: "lucky28", badge: "hot", status: "active",
    bg: g1Img,
    titleClass: "text-figma-12 font-bold font-figma-inter leading-figma-17 text-[#ccb2eb]" },
  { id: "g2", gameId: "lucky28-nz", title: "", category: "lucky28", badge: "new", status: "active",
    bg: g2Img,
  ...
  { id: "g8", gameId: "pk10-kr", title: "", category: "pk10", status: "active",
    bg: g8Img,
  ...
  { id: "g9", gameId: "pk10-vn", title: "", category: "pk10", status: "active",
    bg: g9Img,
